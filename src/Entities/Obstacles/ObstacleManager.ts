...
export class ObstacleManager {
     ...
     */
    placeNewObstacle(gameWindow: Rect, previousGameWindow: Rect): void  {
     ...
     */
    placeObstacleLeft(gameWindow: Rect): void  {
     ...
     */
    placeObstacleRight(gameWindow: Rect): void  {
     ...
     */
    placeObstacleTop(gameWindow: Rect): void  {
     ...
     */
    placeObstacleBottom(gameWindow: Rect): void  {
     ...
     */
    placeRandomObstacle(placementArea: Rect): void  {
