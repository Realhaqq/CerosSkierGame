...
export class Game {
    ...
    skierCaughtByRhino: boolean = false;
    ...
    init(): void  {
        ...
        document.addEventListener("game-Over", this.onGameOverChange.bind(this));
        document.addEventListener("skierCaughtByRhino", this.onSkierCaughtByRhino.bind(this));
    ...
    updateGameWindow(): void  {
        ...
        this.skier.checkIfHitObstacle(this.obstacleManager, this.imageManager);
    ...
    onSkierCaughtByRhino(e: any): void  {
        if (!e || !e.detail) {
            return;
        }
        e.preventDefault();
        this.skierCaughtByRhino = true;
    }
